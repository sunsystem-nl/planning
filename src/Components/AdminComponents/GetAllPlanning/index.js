...
export const GetAllPlanning = () => {
	...
	const [selectedColumns, setSelectedColumns] = useState(JSON.parse(localStorage.getItem('columnsAllPlanning')) || columns)
	...
	const onColumnToggle = (event) => {
		...
		localStorage.setItem('columnsAllPlanning', JSON.stringify(selectedColumns))
	}
	...
	return (
		...
		>
			...
			<iframe id="ifmcontentstoprint" style={{ height: '0px', width: '0px', position: 'absolute', fontSize: '30rem' }} title='getallplanning'></iframe>
